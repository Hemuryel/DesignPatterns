...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AluraLoja.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AluraLoja.Endereco", b =>
                {
            ...
            modelBuilder.Entity("AluraLoja.Endereco", b =>
                {
                    b.HasOne("AluraLoja.Cliente", "Cliente")
                        .WithOne("EnderecoDeEntrega")
                        .HasForeignKey("AluraLoja.Endereco", "ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
